...
export default function AppLovinTab() {
  ...
  const kpiCards = [
    ...
    { id: 'alv-roas', icon: '📈', label: 'Avg ROAS D3', value: `${avgRoas3d.toFixed(1)}%`, color: avgRoas3d >= 70 ? '#10b981' : avgRoas3d >= 50 ? '#f59e0b' : '#ef4444', sub: `Benchmark: 70%`, highlight: true },
    { id: 'alv-buyer', icon: '🛒', label: 'Avg Buyer Rate', value: `${avgBuyerRate.toFixed(1)}%`, color: avgBuyerRate >= 5 ? '#10b981' : avgBuyerRate >= 3 ? '#f59e0b' : '#ef4444', sub: `Benchmark: 5%` },
